  ...
  return (
    <div className="detail-container">
      <Row className="justify-content-center">
        ...
        <Col md={4}>
          <Card className="product-detail" data-aos="fade-left" data-aos-duration="1500">
            <CardBody>
              <h4 className="product-name">{pro.name}</h4>
              <div className="rating">
                {/* You can implement a rating component or simply display stars here */}
                {/* For example: */}
              ...
              <Button color="primary" onClick={() => handleAdd(pro)}>Add to Cart</Button>
            </CardBody>
          </Card>
          <Card className="product-detail" data-aos="fade-up" data-aos-duration="1500">
            <CardBody>
      ...
      <Row className="justify-content-center">
        <Col md={8} className="text-center">
          <Link to="/">
            <Button color="secondary" className="m-3">Trang Chủ</Button>
          </Link>
          <Link to="/products">
            <Button color="secondary" className="m-3">Cửa Hàng</Button>
          </Link>
        </Col>
      </Row>
    </div>
